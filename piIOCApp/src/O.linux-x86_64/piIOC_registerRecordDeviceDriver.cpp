...
/* Generated from ../O.Common/piIOC.dbd */
...
static const char * const deviceSupportNames[] = {
    ...
    "asynInt64ArrayWfOut", "asynInt64TimeSeries", "devWfPDBDemo",
    "devWfPDBDemoRepeat"
};
...
int piIOC_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/xlabsrv2/epics/IOCs/piIOC";
...
/* piIOC_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: piIOC_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(piIOC_registerRecordDeviceDriver(*iocshPpdbbase));
}
